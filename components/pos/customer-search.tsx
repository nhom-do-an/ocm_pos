        ...
        <>
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-sm"
            />
            <button
            ...
            >
              {customers.length > 0 ? (
                ...
                <div className="p-4 text-center">
                  <p className="text-gray-500 text-sm mb-2">Không tìm thấy khách hàng</p>
                  <button
                    onClick={() => setIsAddModalOpen(true)}
